...
export const STUDIO_CATEGORIES = [
   ...
   // ===== REGULAR STUDIOS (43) =====
   {
      ...
      emoji: '👘',
      desc: 'Studios cho áo dài truyền thống và cách tân (7 options)',
      productMatch: ['aodai', 'traditional'],
      studios: [
         'Traditional Cultural ⭐ | Soft ivory-to-warm-beige gradient with hand-painted bamboo branch motifs. Props: Ornate ceramic vase with apricot blossoms on carved wooden pedestal (background right), traditional wooden folding screen panel (background left), silk scroll with calligraphy hanging, bronze incense holder, lotus flowers in bowl, bamboo mat, traditional lantern, scattered petals. Warm golden hour simulation (2700K-3200K) with soft rim light from behind. Light polished wooden floor with traditional Vietnamese rug. Elegant traditional meets modern theatrical stage, Vietnamese cultural pride editorial mini-set. - STUDIO FIXED',
         'Modern Fusion | Clean white-to-light-gray gradient with minimalist geometric pattern. Props: Modern sculptural vase with single stem (background center), contemporary art piece leaning, minimalist pedestal, modern Vietnamese lacquerware, architectural lighting fixture, abstract painting, sleek furniture edge, design books stacked. Bright modern daylight (5000K-6000K) with architectural spots. Polished concrete with area rug modern Vietnamese pattern. Modern Vietnamese fusion theatrical stage, contemporary tradition editorial mini-set. - STUDIO FIXED',
         'Heritage Minimalist | Muted sage-to-cream gradient with subtle traditional textile pattern. Props: Simple wooden altar table (background), heritage ceramic pieces arranged, traditional tea set, woven basket, vintage Vietnamese textiles draped, wooden comb display, heritage book collection, natural fiber mat. Soft natural light (4500K) with zen temple mood. Natural wood planks with simple mat. Minimalist heritage theatrical stage, quiet tradition editorial mini-set. - STUDIO FIXED',
         'Festive Tet | Warm cream-to-gold gradient with festive red accents. Props: Mai flower branches in ornate vase (background center), red lucky envelopes display on tray, traditional Tet decorations multiple, lanterns hanging, fruit offering tray, gold tassel decorations, festive banners, prosperity plants. Festive golden hour (2800K) with warm celebratory glow. Polished wood with red traditional rug, festive scattered petals. Festive Tet celebration theatrical stage, Vietnamese New Year editorial mini-set. - STUDIO FIXED',
         'Garden Poetry | Soft green-to-cream gradient with painted lotus pond motif. Props: Lotus flowers in decorative pond bowl (background center), bamboo water feature, garden stones arranged, bonsai tree miniature, wooden garden bench, traditional garden lantern, poetry scrolls hanging, bird cage decorative. Natural garden daylight (4800K) with dappled light effect. Stone path with moss accent. Vietnamese garden poetry theatrical stage, nature elegance editorial mini-set. - STUDIO FIXED',
         'Royal Palace | Rich gold-to-burgundy gradient with imperial dragon pattern embossed. Props: Ornate throne chair miniature (background center), gold folding fan on stand, royal seal on cushion, palace lanterns hanging, brocade fabric draped, crown on velvet pillow, ceremonial items, royal portrait frame. Regal warm (3000K) with dramatic rim creating palace glow. Glossy dark wood with imperial rug gold pattern. Royal Vietnamese palace theatrical stage, imperial majesty editorial mini-set. - STUDIO FIXED',
         'Countryside Charm | Warm earth-to-cream gradient with rural village texture. Props: Woven conical hat hanging (background left), bamboo basket with rural items, wooden farming tools decorative, clay water jug, traditional village lantern, woven mat, rural flowers in simple vase, countryside fabrics. Natural warm daylight (4200K) with countryside sun. Natural bamboo mat with earth tone. Vietnamese countryside charm theatrical stage, rural heritage editorial mini-set. - STUDIO FIXED'
      ]
   },
   {
      value: 'professional',
   ...
   },
   {
      ...
      emoji: '✨',
      desc: 'Studios cho đầm dạ hội, váy party, đồ tiệc (6 options)',
      productMatch: ['dress', 'maxi_dress', 'bodycon', 'mini_dress', 'gala', 'evening'],
      studios: [
         'Glamorous Bokeh ⭐ | Deep black-to-charcoal gradient with golden bokeh light orbs. Props: Champagne flute on table (background right), jewelry box open with sparkle, mirror with lights, evening clutch bag, perfume bottles luxury, flower arrangement romantic, candles elegant, silk drapes. Warm luxurious (3200K) with bokeh effect dramatic. Glossy black with gold accent rug. Glamorous evening theatrical stage, red carpet editorial mini-set. - STUDIO FIXED',
         'Art Deco Glam | Rich gold-to-black gradient with geometric Art Deco pattern. Props: Art Deco mirror frame (background center), vintage champagne bucket, geometric sculptures, Art Deco vase with feathers, gold cigarette case prop, vintage telephone, crystal decanter, velvet cushions. Warm golden (3000K) with Art Deco theatrical spots. Black and gold geometric tile pattern. Art Deco glamour theatrical stage, Gatsby luxury editorial mini-set. - STUDIO FIXED',
         'Modern Elegance | Sleek gray-to-white gradient with minimalist luxury. Props: Modern sculptural piece (background left), minimalist champagne service, contemporary art, sleek vase with orchid, modern candle holders, geometric jewelry display, silk ribbon, designer handbag hint. Bright modern (4500K) with architectural elegance. Polished marble white with modern rug. Modern elegance theatrical stage, contemporary luxury editorial mini-set. - STUDIO FIXED',
         'Red Carpet | Deep burgundy velvet curtain texture. Props: Award statue gold (background center), photographer flash hints, velvet rope barrier, premiere invitation, champagne glasses, flower bouquet winner, press backdrop, celebrity autograph. Bright camera flash (5500K) with red carpet spotlights. Red carpet runner with gold stanchions. Red carpet Hollywood theatrical stage, celebrity premiere editorial mini-set. - STUDIO FIXED',
         'Garden Party | Twilight lavender-to-pink gradient with evening garden silhouette. Props: String fairy lights overhead (background hanging), champagne service outdoor, flower arrangements wild garden, lanterns hanging, garden furniture elegant, rose petals scattered, garden arch, outdoor candles. Warm fairy light (3000K) with evening garden magic. Stone patio with garden moss accent. Garden evening party theatrical stage, twilight charm editorial mini-set. - STUDIO FIXED',
         'Ballroom Classic | Elegant ivory-to-gold gradient with classical architecture hints. Props: Grand chandelier visible above (background), classical columns hints, ballroom mirror ornate, flower garland draped, classical music stand, dance floor markers, champagne tower, velvet curtains. Warm ballroom (3300K) with chandelier glow. Polished parquet ballroom floor with gold inlay. Ballroom classical theatrical stage, grand ball editorial mini-set. - STUDIO FIXED'
      ]
   },
   {
      value: 'sportswear',
   ...
   {
      value: 'tet_evening',
      label: 'Đầm Váy Tết & Hội',
      emoji: '👗',
      desc: 'Studios Tết cho đầm dạ hội, váy (20 options)',
      ...
      studios: [
         ...
         'Cocktail VIP Tết | Sophisticated navy-to-silver gradient with art deco pattern. Props: Bar counter edge modern (background right), cocktail glass variety, bartool elegant, bottle display backlit, ice sculpture, cocktail shaker, garnish tray, lounge seating plush. Lounge dim (2800K) with neon accent cyan/magenta. Dark polished wood exclusive venue. VIP cocktail party theatrical stage, elite networking editorial. - STUDIO FIXED',
         'Sinh Nhật Hoàng Gia | Regal purple-to-gold gradient with crown pattern embossed. Props: Multi-tier birthday cake elaborate (background center), crown decoration gold, presents wrapped luxury, balloons gold/purple, birthday banner elegant, champagne tower, confetti cannons, throne chair hint. Celebratory bright (4000K) with birthday sparkle. Royal carpet purple gold trim. Royal birthday Tet theatrical stage, majestic party editorial. - STUDIO FIXED',
         'Khai Trương Xa Hoa | Opulent red-to-gold gradient with ribbon-cutting ceremony. Props: Ribbon-cutting setup ceremonial (background center), grand opening flower stands multiple, champagne service, guest registry book, brand logos display, ceremonial scissors gold, red carpet entrance, promotional banners. Event bright (5500K) celebratory launch. Marble entrance grand venue red carpet. Luxury brand opening theatrical stage, grand launch editorial. - STUDIO FIXED',
